...
Best way to submit bugs is to attach a screenshot of the console app [like so](https://raw.githubusercontent.com/timuric/Content-generator-sketch-plugin/master/tutorial/console.png) (use "sketch" in filter box)
